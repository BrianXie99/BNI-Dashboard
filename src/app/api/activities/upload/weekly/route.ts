  ...
  try {
    ...
    const activities = data.map((row: any) => {
      ...
      return {
        ...
        weekNumber,
        year,
        attendance: mapped.attendance || '出席',
        provideInsideRef: mapped.provideInsideRef || 0,
        provideOutsideRef: mapped.provideOutsideRef || 0,
        receivedInsideRef: mapped.receivedInsideRef || 0,
        receivedOutsideRef: mapped.receivedOutsideRef || 0,
        visitors: mapped.visitors || 0,
        oneToOneVisit: mapped.oneToOneVisit || 0,
        tyfcb: mapped.tyfcb || 0,
        ceu: mapped.ceu || 0,
        uploadedBy,
      };
